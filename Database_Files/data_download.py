...
######
default_data = pd.read_json('default.json')
...
new_default_data = pd.read_csv('temp.csv')
remove('temp.csv')
...
# Write to File
new_default_data.to_csv('default.csv', index=False)

######
# Convert oracle JSON to CSV
######
oracle_data = pd.read_json('oracle.json')
...
selection.to_csv('temp.csv', index=False)
new_oracle_data = pd.read_csv('temp.csv')
remove('temp.csv')
...
new_oracle_data.to_csv('oracle.csv', index=False)
